...
const AddIssue = ({ addIssue }) => {
  ...
  const notify = () => toast.success('added the task', 
    ...
    <div >
          ...
          >
            {({ isValid, values, setFieldValue }) => (
              <Form className='form-group mt-5'>
                ...
                <Field className='form-control'type="input" id="description" name="description" />
                <ErrorMessage name="description">
                  {(msg) => <div className="alert alert-danger fs-6 form-text" style={{'margin':'10px 240px 0px 240px'}}>{msg}</div>}
                </ErrorMessage>
                </div>
                 </div>
                 <br />
          <div className="row ">
                <label  className="col-sm-2 col-form-label" htmlFor="status">Status:</label>
                 <div className="col-sm-8">
                <Field className='form-select' name="status" as="select" className="form-select">
                ...
                <br />
                <div className='row'>
                <label className="col-sm-2 col-form-label" htmlFor="severity">Severity:</label>
                ...
                >
                  <Field className='form-check-input'type="radio" value="Minor" name="severity" style={{margin:'3px 10px 2px 10px'}}/>
                  Minor
                </label>
                <label
                ...
                >
                  <Field className='form-check-input' type="radio" value="Major" name="severity" style={{margin:'3px 10px 2px 10px'}}/>
                  Major
                </label>
                <label
                  className="form-check-label"
                ...
                <br />
                <div className='row'>
                <label className="col-sm-2 col-form-label" htmlFor="dateCreated">Date Created:</label>
                ...
                <label className="col-sm-2 col-form-label" htmlFor="dateResolved">Date Resolved:</label>
